...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "z",
        ...
        {description="change screens layout", group="awesome"}),
    ...
    awful.key({ }, "Print", function () awful.util.spawn("sleep 0.5 && scrot -s -e 'mv $f ~/Pictures/scrot/ 2>/dev/null'", false) end,
        {description = "Take a screenshot of entire screen", group = "screenshot"}),
    ...
    awful.key({ modkey,  }, "Print",
        function()
            awful.util.spawn("sleep 0.2 && scrot -s ~/Pictures/scrot/$(date +%F_%T).png", false)
        end
        , 
        {description = "Take a screenshot of selection", group = "screenshot"}),
